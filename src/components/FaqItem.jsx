...
const FaqItem = ({ item, index }) => {
  ...
  return (
    <div className="relative z-2 mb-16">
      <div className="group relative flex cursor-pointer item-center justify-between gap-10 px-7" 
      onClick={() => {
      ...
      >
        ...
        <div className={clsx("faq-icon relative flex size-12 items-center justify-center rounded-full border-2 border-s2 shadow-400 transition-all duration-500 group-hover:border-s4",
            ...
            <div className={clsx("g4 size-11/12 rounded-full shadow-300", active && "absolute")}/>
        </div>
      </div>
