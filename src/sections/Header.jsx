...
const Header = () => {
  ...
  return (
    <header className={clsx("fixed top-0 left-0 z-100 w-full py-3 transition-all duration-500 max-lg:py-4", hasScrolled && 'py-2 bg-black-100 backdrop-blur-[8px]' )}>
      <div className="container flex h-14 items-center max-lg:px-5"> 
        <a className="lg:hidden flex-1 cursor-pointer z-2" href="hero">
